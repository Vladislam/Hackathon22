package com.dungeon.software.hackathon.base.widget
...
class TextViewContainerFlow @JvmOverloads constructor(
    context: Context,
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.TextViewContainerFlow, defStyleAttr) {
            verticalOffset =
                getDimensionPixelOffset(R.styleable.TextViewContainerFlow_verticalOffset, 0)
        }
    }
